...
Version  : 25.04.2
Release  : 54
URL      : https://download.kde.org/stable/release-service/25.04.2/src/kaccounts-integration-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kaccounts-integration-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kaccounts-integration-25.04.2.tar.xz.sig
...
%setup -q -n kaccounts-integration-25.04.2
cd %{_builddir}/kaccounts-integration-25.04.2
pushd ..
cp -a kaccounts-integration-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749528088
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkaccounts6.so.25.04.2
...
/usr/lib64/libkaccounts6.so.25.04.2
