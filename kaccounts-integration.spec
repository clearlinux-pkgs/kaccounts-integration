...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kaccounts-integration-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kaccounts-integration-24.08.0.tar.xz.sig
...
%setup -q -n kaccounts-integration-24.08.0
cd %{_builddir}/kaccounts-integration-24.08.0
pushd ..
cp -a kaccounts-integration-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724660404
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkaccounts6.so.24.08.0
...
/usr/lib64/libkaccounts6.so.24.08.0
