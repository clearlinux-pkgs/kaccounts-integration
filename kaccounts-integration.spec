...
Version  : 24.12.1
Release  : 49
URL      : https://download.kde.org/stable/release-service/24.12.1/src/kaccounts-integration-24.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/kaccounts-integration-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/kaccounts-integration-24.12.1.tar.xz.sig
...
%setup -q -n kaccounts-integration-24.12.1
cd %{_builddir}/kaccounts-integration-24.12.1
pushd ..
cp -a kaccounts-integration-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736571464
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkaccounts6.so.24.12.1
...
/usr/lib64/libkaccounts6.so.24.12.1
