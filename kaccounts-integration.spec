...
Version  : 23.08.2
Release  : 30
URL      : https://download.kde.org/stable/release-service/23.08.2/src/kaccounts-integration-23.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/kaccounts-integration-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/kaccounts-integration-23.08.2.tar.xz.sig
...
%prep
%setup -q -n kaccounts-integration-23.08.2
cd %{_builddir}/kaccounts-integration-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697409807
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkaccounts.so.23.08.2
...
/usr/lib64/libkaccounts.so.23.08.2
