...
Version  : 23.04.0
Release  : 23
URL      : https://download.kde.org/stable/release-service/23.04.0/src/kaccounts-integration-23.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/kaccounts-integration-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/kaccounts-integration-23.04.0.tar.xz.sig
...
%prep
%setup -q -n kaccounts-integration-23.04.0
cd %{_builddir}/kaccounts-integration-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682115621
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkaccounts.so.23.04.0
