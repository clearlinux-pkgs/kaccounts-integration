...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kaccounts-integration-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kaccounts-integration-24.12.3.tar.xz.sig
...
%setup -q -n kaccounts-integration-24.12.3
cd %{_builddir}/kaccounts-integration-24.12.3
pushd ..
cp -a kaccounts-integration-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742526196
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkaccounts6.so.24.12.3
...
/usr/lib64/libkaccounts6.so.24.12.3
