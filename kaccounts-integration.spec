...
Version  : 24.12.0
Release  : 48
URL      : https://download.kde.org/stable/release-service/24.12.0/src/kaccounts-integration-24.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/kaccounts-integration-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/kaccounts-integration-24.12.0.tar.xz.sig
...
%setup -q -n kaccounts-integration-24.12.0
cd %{_builddir}/kaccounts-integration-24.12.0
pushd ..
cp -a kaccounts-integration-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735330752
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkaccounts6.so.24.12.0
...
/usr/lib64/libkaccounts6.so.24.12.0
