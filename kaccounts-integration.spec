...
Source0  : https://download.kde.org/stable/release-service/21.12.2/src/kaccounts-integration-21.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.2/src/kaccounts-integration-21.12.2.tar.xz.sig
...
%prep
%setup -q -n kaccounts-integration-21.12.2
cd %{_builddir}/kaccounts-integration-21.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644028965
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kaccounts-integration-21.12.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kaccounts-integration/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/kaccounts-integration-21.12.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kaccounts-integration/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kaccounts-integration-21.12.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kaccounts-integration/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/kaccounts-integration-21.12.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kaccounts-integration/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kaccounts-integration-21.12.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kaccounts-integration/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kaccounts-integration-21.12.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kaccounts-integration/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
...
/usr/lib64/libkaccounts.so.21.12.2
