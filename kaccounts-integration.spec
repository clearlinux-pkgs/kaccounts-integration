...
Version  : 24.05.1
Release  : 40
URL      : https://download.kde.org/stable/release-service/24.05.1/src/kaccounts-integration-24.05.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/kaccounts-integration-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/kaccounts-integration-24.05.1.tar.xz.sig
...
%setup -q -n kaccounts-integration-24.05.1
cd %{_builddir}/kaccounts-integration-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718594927
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkaccounts6.so.24.05.1
...
/usr/lib64/libkaccounts6.so.24.05.1
