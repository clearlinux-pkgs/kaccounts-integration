...
Version  : 24.08.1
Release  : 45
URL      : https://download.kde.org/stable/release-service/24.08.1/src/kaccounts-integration-24.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/kaccounts-integration-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/kaccounts-integration-24.08.1.tar.xz.sig
...
%setup -q -n kaccounts-integration-24.08.1
cd %{_builddir}/kaccounts-integration-24.08.1
pushd ..
cp -a kaccounts-integration-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726252266
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkaccounts6.so.24.08.1
...
/usr/lib64/libkaccounts6.so.24.08.1
