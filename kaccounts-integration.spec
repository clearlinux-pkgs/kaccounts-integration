...
Version  : 24.02.2
Release  : 37
URL      : https://download.kde.org/stable/release-service/24.02.2/src/kaccounts-integration-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/kaccounts-integration-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/kaccounts-integration-24.02.2.tar.xz.sig
...
%setup -q -n kaccounts-integration-24.02.2
cd %{_builddir}/kaccounts-integration-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712884118
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkaccounts6.so.24.02.2
...
/usr/lib64/libkaccounts6.so.24.02.2
