...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kaccounts-integration-22.08.0.tar.xz
...
%prep
%setup -q -n kaccounts-integration-22.08.0
cd %{_builddir}/kaccounts-integration-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661557168
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkaccounts.so.22.08.0
