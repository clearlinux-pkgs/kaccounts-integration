...
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/kaccounts-integration-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/kaccounts-integration-25.04.1.tar.xz.sig
...
%setup -q -n kaccounts-integration-25.04.1
cd %{_builddir}/kaccounts-integration-25.04.1
pushd ..
cp -a kaccounts-integration-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747193490
mkdir -p clr-build
pushd clr-build
...
/usr/share/qlogging-categories6/kaccounts.categories
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkaccounts6.so.25.04.1
...
/usr/lib64/libkaccounts6.so.25.04.1
